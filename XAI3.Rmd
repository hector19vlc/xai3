...
```{r}
p1 = ggplot(sampled, aes(x=bedrooms,y=results$bedrooms)) + geom_line() + labs(x='Bedrooms',y='')
p2 = ggplot(sampled, aes(x=bathrooms,y=results$bathrooms)) +geom_line()+labs(x='Bathrooms',y='')
p3 = ggplot(sampled, aes(x=sqft_living,y=results$sqft_living))+geom_line()+ labs(x='Sqft Livings',y='')
p4 = ggplot(sampled, aes(x=floors,y=results$floors))+geom_line()+ labs(x='Floors',y='')
